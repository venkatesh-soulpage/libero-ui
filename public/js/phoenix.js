        ...
        A = (function () {
          function e(t, n, i) {
            ...
            c(this, e),
              ...
              (this.joinedOnce = !1),
              (this.joinPush = new _(this, T, this.params, this.timeout)),
              (this.pushBuffer = []),
              (this.stateChangeRefs = []),
              (this.rejoinTimer = new I(function () {
        ...
        J = (function () {
          function e(t) {
            ...
            c(this, e),
              ...
              (this.transport = i.transport || d.WebSocket || H),
              (this.defaultEncoder = M.encode),
              (this.defaultDecoder = M.decode),
              ...
              (this.params = L(i.params || {})),
              (this.endPoint = "".concat(t, "/").concat(P)),
              (this.vsn = i.vsn || "2.0.0"),
              (this.heartbeatTimer = null),
              (this.pendingHeartbeatRef = null),
              (this.reconnectTimer = new I(function () {
                n.teardown(function () {
                  return n.connect();
                });
          ...
          return (
            h(e, [
              ...
              },
              {
                key: "endPointURL",
                value: function () {
                  var e = D.appendParams(
                    D.appendParams(this.endPoint, this.params()),
                    { vsn: this.vsn }
                  );
                  return "/" !== e.charAt(0)
                    ? e
